...
# sys.stdout = open("console_outputs/console_output_lr-5_all_feats_nonorm_esm_GTN5.txt", "w")
...
def train(device, g, feature, edges, model, name):
    ...
    for epoch in range(EPOCHS):
        ...
        if acc > best_val_acc:
           ...
           checkpoint_dir = "updated_esm_graph_checkpoints" #"final_checkpoints"
           os.makedirs(checkpoint_dir, exist_ok=True)
           checkpoint_path = os.path.join(checkpoint_dir, f"{feature}_{name}_lr_1e-4_updated_esm_checkpoint.pth")
