...
import sys
sys.stdout = open("final_console_outputs/console_output_lr-2_all_graph_bioembed_gat_run1_no_normedge.txt", "w")
...
def train(device, g, feature, edges, model, name):
    ...
    opt = th.optim.Adam(model.parameters(), lr=1e-2) #1e-2
    ...
    for epoch in range(EPOCHS):
        ...
        if acc > best_val_acc:
            ...
            checkpoint_dir = "final_checkpoints" #"final_checkpoints"
            os.makedirs(checkpoint_dir, exist_ok=True)
            checkpoint_path = os.path.join(checkpoint_dir, f"{feature}_{name}_lr_1e-2_checkpoint_r1.pth")
...
def run_app(device, graph, edges):
  ...
  for feature in features:
    ...
    # =============================================================================
        # Run GTN_g2 Model  works well with edges
    # =============================================================================
...
# # Replace all values of 'bioembed_feat' with zeros
# g.ndata['bioembed_feat'] = torch.zeros_like(g.ndata['bioembed_feat'])
